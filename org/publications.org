...
#+INCLUDE: ./logo.org
#+begin_export html
<script> document.querySelectorAll("#mySideNav a#publications")[0].classList.add("active"); </script>
#+end_export

* Journals
- Kanishak Vaidya and B. Sundar Rajan, *``Multi-Access Cache-Aided Multi-user Private Information Retrieval''* in IEEE Transactions on Communications, doi: 10.1109/TCOMM.2024.3375810. [[[https://ieeexplore.ieee.org/document/10464318][IEEE]]]
